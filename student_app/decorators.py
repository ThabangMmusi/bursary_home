...
def profile_complete_required(view_func):
    def _wrapped_view(request, *args, **kwargs):
        if not request.user.is_authenticated:
            return redirect('student_app:login')  # Or your login URL name
        ...
        try:
            ...
            if not student.is_profile_complete():
                ...
                return redirect('student_app:complete-profile')  # Or your profile completion URL name
            ...
            return redirect('student_app:complete-profile') # Or your profile creation URL name
