"""
Django settings for bursary_home project.
...
SECRET_KEY = 'django-insecure-=o*(w_cj@&fyoqhmir%ig00&c(5=(&di1_z(@x3tp&w%0d1&^o'
...
WSGI_APPLICATION = 'bursary_home.wsgi.application'
...
LOGOUT_REDIRECT_URL = '/'  # Redirect to home/login page after logout
