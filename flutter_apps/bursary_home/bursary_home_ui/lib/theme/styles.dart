...
// Note: If you are not using google_fonts package directly here for TextStyles,
// ensure "Poppins" font is correctly set up in your pubspec.yaml and assets.

/// //////////////////////////////////////////////////////////////
/// Styles - Contains the design system for the entire app.
/// Includes paddings, text styles, timings etc. Does not include colors,
/// these should be defined and used via the AppTheme's ColorScheme.
...
class Shadows {
  ...
  static final List<BoxShadow> universal = [
    BoxShadow(
      color: _defaultShadowColor.withOpacity(0.08),
      blurRadius: 4,
      offset: const Offset(0, 1),
    ),
    BoxShadow(
      color: _defaultShadowColor.withOpacity(0.06),
      blurRadius: 12,
  ...
  static final List<BoxShadow> small = [
    BoxShadow(
      color: _defaultShadowColor.withOpacity(0.07),
      blurRadius: 3,
      offset: const Offset(0, 1),
    ),
  ];
  ...
  static final List<BoxShadow> large = [
    BoxShadow(
      color: _defaultShadowColor.withOpacity(0.1),
      blurRadius: 16,
